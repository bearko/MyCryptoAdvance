...
export const STAGE_WAVES = {
  sekigahara_field: {
    ...
    totalEnemies: 680,
    waves: [
      // 序盤: 前方からザコが群れで押し寄せる（無双チュートリアル）
      { time: 0,   enemies: ['creeper_s'], count: 20, interval: 0.3, spawnDir: [-Math.PI/2, 0.4] },
      { time: 8,   enemies: ['creeper_s', 'creeper_s'], count: 25, interval: 0.2, spawnDir: [-Math.PI/2, 0.5] },
      { time: 18,  enemies: ['creeper_s', 'creeper_t'], count: 30, interval: 0.18, spawnDir: [-Math.PI/2, 0.6] },
      { time: 32,  enemies: ['elk_s', 'creeper_s', 'creeper_s'], count: 35, interval: 0.15, spawnDir: [-Math.PI/2, 0.7] },
      // 左右にも広がり始める
      { time: 48,  enemies: ['creeper_t', 'elk_s', 'heart_s'], count: 40, interval: 0.14, spawnDir: [-Math.PI/2, 1.0] },
      { time: 68,  enemies: ['melissa_s', 'creeper_t', 'elk_s', 'creeper_s'], count: 45, interval: 0.12, spawnDir: [-Math.PI/2, 1.2] },
      { time: 75,  event: 'rescue', heroKey: 'kaihime' },
      // 甲斐姫合流後、敵の質が上がる
      { time: 80,  enemies: ['creeper_g', 'elk_t', 'melissa_s', 'heart_s'], count: 50, interval: 0.12, spawnDir: [-Math.PI/2, 1.4] },
      { time: 100, enemies: ['heart_t', 'melissa_t', 'elk_g', 'creeper_t'], count: 50, interval: 0.10, spawnDir: [-Math.PI/2, 1.6] },
      { time: 120, enemies: ['melissa_t', 'elk_t', 'bandit_s', 'heart_t'], count: 55, interval: 0.10, spawnDir: [-Math.PI/2, 1.8] },
      { time: 140, event: 'rescue', heroKey: 'ranmaru' },
      // 蘭丸合流、全方位展開
      { time: 145, enemies: ['creeper_v', 'bandit_s', 'melissa_g', 'elk_g'], count: 55, interval: 0.09, spawnDir: [-Math.PI/2, 2.2] },
      { time: 170, enemies: ['bandit_t', 'elk_g', 'heart_g', 'melissa_g', 'bagel_s'], count: 60, interval: 0.08 },
      { time: 195, enemies: ['bandit_t', 'creeper_v', 'melissa_g', 'elk_g'], count: 60, interval: 0.08 },
      { time: 215, event: 'rescue', heroKey: 'yukimura' },
      // 幸村合流、エリート敵ラッシュ
      { time: 220, enemies: ['creeper_f', 'melissa_f', 'bandit_t', 'elk_g'], count: 50, interval: 0.10 },
      { time: 250, enemies: ['elk_f', 'bandit_f', 'melissa_f', 'bagel_v', 'creeper_v'], count: 40, interval: 0.12 },
      { time: 280, event: 'boss', bossType: 'bandit_f', bossScale: 2.5, bossHpMul: 8, bossDmgMul: 2 },
    ],
